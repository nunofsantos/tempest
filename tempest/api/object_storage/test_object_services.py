...
class ObjectTest(base.BaseObjectTest):
    ...
    def _upload_segments(self):
        ...
        segments = 10
        data_segments = [
            data_utils.to_bytes(data + str(i)) for i in range(segments)]
        # uploading segments
    ...
    def test_create_object(self):
        ...
        data = data_utils.arbitrary_bytes()
    ...
    def test_create_object_with_transfer_encoding(self):
        ...
        object_name = data_utils.rand_name(name='TestObject')
        data = data_utils.arbitrary_bytes(1024)
    ...
    def test_get_object_with_range(self):
        ...
        object_name = data_utils.rand_name(name='TestObject')
        data = data_utils.arbitrary_bytes(100)
        self.object_client.create_object(self.container_name,
                                         object_name,
                                         data,
                                         metadata=None)
    ...
    def test_get_object_with_if_none_match(self):
        ...
        list_data = data_utils.arbitrary_bytes(15)
    ...
    def test_copy_object_in_same_container(self):
        ...
        src_data = data_utils.arbitrary_bytes(size=len(src_object_name) * 2,
        ...
        dst_data = data_utils.arbitrary_bytes(size=len(dst_object_name) * 3,
    ...
    def test_copy_object_across_containers(self):
        ...
        data = data_utils.arbitrary_bytes(size=len(object_name) * 2,
    ...
    def test_get_object_if_different(self):
        ...
        local_data = b"something different"
...
class PublicObjectTest(base.BaseObjectTest):
    ...
    def test_access_public_container_object_without_using_creds(self):
        ...
        # create object
        object_name = data_utils.rand_name(name='Object')
        data = data_utils.arbitrary_bytes(size=len(object_name),
                                          base_text=object_name)
        resp, _ = self.object_client.create_object(self.container_name,
                                                   object_name, data)
        self.assertHeaders(resp, 'Object', 'PUT')
    ...
    def test_access_public_object_with_another_user_creds(self):
        ...
        # create object
        object_name = data_utils.rand_name(name='Object')
        data = data_utils.arbitrary_bytes(size=len(object_name) * 1,
                                          base_text=object_name)
        resp, _ = self.object_client.create_object(self.container_name,
                                                   object_name, data)
        self.assertHeaders(resp, 'Object', 'PUT')
